...
let WidgetRatingTool = (_dec = NearBindgen({}), _dec2 = call({}), _dec3 = view(), _dec4 = view(), _dec5 = view(), _dec(_class = (_class2 = class WidgetRatingTool {
  // what does this need to do?

  // It needs to track if a user has already participated in a particular rating
  userRatingTracker = new UnorderedMap("rating_tracker");

  // keep track of the rating that the user gave a widget
  userRatingObject = new UnorderedMap("user_ranking");

  // keep track of each individual rating and return an average
  rankingArrayTracker = new UnorderedMap("ranking array tracker");
  ...
  newRanking(rateVal, widgetName) {
    let user = signerAccountId();
  ...
  getVoteObject({
    ...
    log("getting user Rating Object");
    let userObject = this.userRatingObject.get(user, {
      defaultValue: {}
    });
  ...
  userParticipation({
    ...
    let userList = this.userRatingTracker.get(widgetName, {
      defaultValue: []
    });
    return userList.includes(user);
  }
}, (_applyDecoratedDescriptor(_class2.prototype, "newRanking", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "newRanking"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getVoteObject", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "getVoteObject"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getVoteAverage", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "getVoteAverage"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "userParticipation", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "userParticipation"), _class2.prototype)), _class2)) || _class);
function userParticipation() {
  const _state = WidgetRatingTool._getState();
  if (!_state && WidgetRatingTool._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  const _contract = WidgetRatingTool._create();
  if (_state) {
    WidgetRatingTool._reconstruct(_contract, _state);
  }
  const _args = WidgetRatingTool._getArgs();
  const _result = _contract.userParticipation(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(WidgetRatingTool._serialize(_result, true));
}
function getVoteAverage() {
  ...
  const _args = WidgetRatingTool._getArgs();
  const _result = _contract.getVoteAverage(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(WidgetRatingTool._serialize(_result, true));
}
function getVoteObject() {
  ...
  const _args = WidgetRatingTool._getArgs();
  const _result = _contract.getVoteObject(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(WidgetRatingTool._serialize(_result, true));
}
function newRanking() {
  const _state = WidgetRatingTool._getState();
  ...
  const _args = WidgetRatingTool._getArgs();
  const _result = _contract.newRanking(_args);
  WidgetRatingTool._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(WidgetRatingTool._serialize(_result, true));
}

export { getVoteAverage, getVoteObject, newRanking, userParticipation };
